...
import { computeExportKindModifier } from './compute-export-kind-modifier.js'
...
function sortNamedExport({ matchedAstSelectors, context, node }) {
...
export { defaultOptions, sortNamedExport }
